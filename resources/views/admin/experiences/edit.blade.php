                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h3 class="mb-sm-0">Edit Experience Blog</h3>
                        ...
                        <form method="post" action="{{ route('experience.update', $experience->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{  url('upload/experience/blog/' . $experience->image) }}" alt="Image" style="max-width: 200px;">
                                </div>
                            </div>
                            <!-- end row -->
