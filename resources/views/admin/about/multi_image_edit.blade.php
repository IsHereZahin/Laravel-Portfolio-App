            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('about.multi-image.update', ['id' => $multi_image->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ asset('upload/about/multiimage/' . $multi_image->multi_image) }}" alt="Card image cap">
                                </div>
                            </div>
                            <!-- end row -->
